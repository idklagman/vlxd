    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4 pt-2 text-xs border-t">
          <div className="flex items-center gap-4 bg-gray-50 p-3.5 rounded-xl border border-gray-300 text-xs">
            <img
              ...
              className="w-40 h-40 object-contain border-2 border-primary/40 bg-white rounded-lg p-1.5 shrink-0 shadow-xs"
              onError={(e) => {
                (e.target as HTMLElement).style.display = 'none';
              }}
            />
            <div className="space-y-1">
              <p className="font-extrabold text-primary text-xs uppercase tracking-wide">Quét mã VietQR chuyển khoản</p>
              ...
              <p className="text-xs text-muted-foreground pt-1 border-t border-gray-200">
                Nội dung CK: <strong className="font-mono text-black font-bold">{order.code}</strong>
              </p>
            </div>
          </div>
